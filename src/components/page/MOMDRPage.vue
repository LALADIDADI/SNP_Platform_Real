...
import {MOMDRParamsUpload, MOMDRPollResultData, MOMDRResultShow, MOMDRForceStop} from '../../api/index'
...
export default {
  ...
  methods: {
    // 强制终止方法
    forceStop () {
      MOMDRForceStop().then(res => {
        console.log('MOMDR进程已全部停止')
        // 提示
        this.$message({
          message: `MOMDR进程已全部停止`,
          type: `success`
        })
      })
    },
